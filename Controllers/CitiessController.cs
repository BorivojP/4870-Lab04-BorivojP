...
{
    public class CitiessController : Controller
    {
        private readonly ApplicationDbContext _context;

        public CitiessController(ApplicationDbContext context)
        {
            _context = context;
        }
